...
export function DrivePad({ sendCommand, speedScale, disabled = false }: DrivePadProps) {
  ...
  const btn = "aspect-square rounded-md border border-blue-400/25 bg-blue-400/5 font-mono text-sm font-medium transition-colors hover:bg-blue-400/15 active:bg-blue-400/25 disabled:opacity-30";
  ...
  return (
    <div className="rounded-md border border-border p-2">
      ...
      <button
        className="mt-1.5 w-full h-[66px] rounded-md border border-red-400/30 bg-red-400/10 font-mono text-base font-medium text-red-400 hover:bg-red-400/20 disabled:opacity-30"
        disabled={disabled}
