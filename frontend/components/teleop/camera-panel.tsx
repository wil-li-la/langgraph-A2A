  ...
  return (
    <Tabs defaultValue="overhead" className="h-full flex flex-col">
      <TabsList className="grid w-full grid-cols-3 shrink-0 bg-muted/50">
        <TabsTrigger value="overhead" className="font-mono text-sm">OVERHEAD</TabsTrigger>
        <TabsTrigger value="gripper" className="font-mono text-sm">GRIPPER</TabsTrigger>
        <TabsTrigger value="map" className="font-mono text-sm">MAP</TabsTrigger>
      </TabsList>
